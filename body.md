...
You can review and revoke your authorization at any time. For more information, see [Reviewing and revoking authorization of GitHub Apps](/en/enterprise-cloud@latest/apps/using-github-apps/reviewing-your-authorized-integrations).

> \[!NOTE]
> If your organization uses SSO and you cannot see your organization's resources after you authorize a GitHub App, you may need to reauthorize the app after starting an active SSO session for your organization. For more information, see [SAML and GitHub Apps](/en/enterprise-cloud@latest/apps/using-github-apps/saml-and-github-apps).
